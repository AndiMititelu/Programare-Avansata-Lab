...
public class Database {
    private static final String url = "jdbc:postgresql://localhost:5432/PAdb";
    ...
    public static void createTables() {
        try {
            ...
            String genresTable = "CREATE TABLE IF NOT EXISTS genres (id SERIAL PRIMARY KEY, name TEXT)";
